...
public class FullscreenOnListener
	implements ActionListener{		
	
	private var zanmantou:Zanmantou3;

	public function FullscreenOnListener(zanmantou:Zanmantou3){
	...
	public function actionPerformed(e:Event):void{
		...
		// trigger js event
		this.zanmantou.getJSAPI().triggerEvent("fullscreenon", "");
		
		this.zanmantou.getComponentManager().enableFullscreen(true);
		
		// swap buttons
		ui.displayButtons("fullscreenoff", true);
		ui.displayButtons("fullscreenon", false);
	}
