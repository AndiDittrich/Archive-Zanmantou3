...
public class VisionLightOffListener
	implements ActionListener{		
	
	private var zanmantou:Zanmantou3;

	public function VisionLightOffListener(zanmantou:Zanmantou3){
	...
	public function actionPerformed(e:Event):void{
		...
		// trigger js event
		this.zanmantou.getJSAPI().triggerEvent("visionlightoff", "");
		
		// start item
		this.zanmantou.getVisionLightManager().enable(false);
		
		// swap buttons
		ui.displayButtons("visionlighton", true);
		ui.displayButtons("visionlightoff", false);
	}
