...
public class RepeatOffListener
	implements ActionListener{		
	
	private var zanmantou:Zanmantou3;

	public function RepeatOffListener(zanmantou:Zanmantou3){
	...
	public function actionPerformed(e:Event):void{
		...
		// trigger js event
		this.zanmantou.getJSAPI().triggerEvent("repeatoff", "");
		
		// start item
		this.zanmantou.getMediaManager().getMediaList().enableRepeat(false);
		
		// swap buttons
		ui.displayButtons("repeatoff", false);
		ui.displayButtons("repeaton", true);
	}
