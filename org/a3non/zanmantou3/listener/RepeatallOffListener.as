...
public class RepeatallOffListener
	implements ActionListener{		
	
	private var zanmantou:Zanmantou3;

	public function RepeatallOffListener(zanmantou:Zanmantou3){
	...
	public function actionPerformed(e:Event):void{
		...
		// trigger js event
		this.zanmantou.getJSAPI().triggerEvent("repeatalloff", "");
		
		// start item
		this.zanmantou.getMediaManager().getMediaList().enableRepeatall(false);
		
		// swap buttons
		ui.displayButtons("repeatalloff", false);
		ui.displayButtons("repeatallon", true);
	}
