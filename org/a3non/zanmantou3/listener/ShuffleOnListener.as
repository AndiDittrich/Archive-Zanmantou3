...
public class ShuffleOnListener
	implements ActionListener{		
	
	private var zanmantou:Zanmantou3;

	public function ShuffleOnListener(zanmantou:Zanmantou3){
	...
	public function actionPerformed(e:Event):void{
		...
		// trigger js event
		this.zanmantou.getJSAPI().triggerEvent("shuffleon", "");
		
		// start item
		this.zanmantou.getMediaManager().getMediaList().enableShuffle(true);
		
		// swap buttons
		ui.displayButtons("shuffleoff", true);
		ui.displayButtons("shuffleon", false);
	}
