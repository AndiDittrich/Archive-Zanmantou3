...
public class VisionLightOnListener
	implements ActionListener{		
	
	private var zanmantou:Zanmantou3;

	public function VisionLightOnListener(zanmantou:Zanmantou3){
	...
	public function actionPerformed(e:Event):void{
		...
		// trigger js event
		this.zanmantou.getJSAPI().triggerEvent("visionlighton", "");
		
		// start item
		this.zanmantou.getVisionLightManager().enable(true);
		
		// swap buttons
		ui.displayButtons("visionlightoff", true);
		ui.displayButtons("visionlighton", false);
	}
