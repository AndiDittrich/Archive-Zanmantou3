...
public class SmoothingOffListener
	implements ActionListener{		
	
	private var zanmantou:Zanmantou3;

	public function SmoothingOffListener(zanmantou:Zanmantou3){
	...
	public function actionPerformed(e:Event):void{
		...
		// trigger js event
		this.zanmantou.getJSAPI().triggerEvent("smoothingoff", "");
		
		// start item
		this.zanmantou.getMediaManager().getVideoEngine().enableSmoothing(false);
		
		// swap buttons
		ui.displayButtons("smoothingoff", false);
		ui.displayButtons("smoothingon", true);
	}
