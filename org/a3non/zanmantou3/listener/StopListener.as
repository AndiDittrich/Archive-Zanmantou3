...
public class StopListener
	...
	public function StopListener(zanmantou:Zanmantou3){
	...
	public function actionPerformed(e:Event):void{
		...
		// trigger js event
		this.zanmantou.getJSAPI().triggerEvent("stop", "");
		
		// start item
		this.zanmantou.getMediaManager().stop();
		
		// swap start/pause buttons
		ui.displayButtons("start", true);
		ui.displayButtons("pause", false);
	}
