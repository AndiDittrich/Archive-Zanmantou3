...
public class UnmuteListener
	implements ActionListener{		
	
	private var zanmantou:Zanmantou3;

	public function UnmuteListener(zanmantou:Zanmantou3){
		this.zanmantou = zanmantou;
	}

	public function actionPerformed(e:Event):void{
		this.zanmantou.getSoundManager().unmute();
		this.zanmantou.getJSAPI().triggerEvent("unmute", "");
		
		var ui:UserInterface = this.zanmantou.getUserInterface();
	
		// swap start/pause buttons
		ui.displayButtons("unmute", false);
		ui.displayButtons("mute", true);
	}
